...
@Entity
public class InstagramConfiguracao implements Serializable
{
	...
	private long pkInstagramConfiguracao;
	...
	/*-*-*-* Construtores *-*-*-*/
	public InstagramConfiguracao() { }

	/*-*-*-* Metodos Gets e Sets *-*-*-*/
	public long getPkInstagramConfiguracao() { return pkInstagramConfiguracao; }
	public void setPkInstagramConfiguracao(long pkInstagramConfiguracao) { this.pkInstagramConfiguracao = pkInstagramConfiguracao; }
